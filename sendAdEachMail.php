...
function sendAdEachMail($app_key, $api_function, $receiveMailAddr, $receiveName, $receiveType, $senderAddress, $title, $body){
...
sendAdEachMail($app_key, $adEachMailApi, $receiveMailAddr, $receiveName, $receiveType, $senderAddress, $title, $body);
