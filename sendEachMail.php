...
function sendEachMail($app_key, $api_function, $receiveMailAddr, $receiveName, $receiveType, $senderAddress, $title, $body){
...
sendEachMail($app_key, $standardMailApi, $receiveMailAddr, $receiveName, $receiveType, $senderAddress, $title, $body);
